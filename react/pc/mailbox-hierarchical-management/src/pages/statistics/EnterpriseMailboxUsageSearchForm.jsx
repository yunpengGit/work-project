...
const EnterpriseUsageSearchForm = (props) => {
		...
		<Form ref={formRef} className="ant-advanced-search-form" onFinish={onFinish}>
          ...
          >
            <Select
              ...
              allowClear
            >
              <Option value="">收信日志</Option>
              <Option value="1">发信日志</Option>
              <Option value="0">删除日志</Option>
            </Select>
          </Form.Item>
        </Col> */}
				{identity == '1' ? (
...
export default EnterpriseUsageSearchForm
