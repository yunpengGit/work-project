                        ...
                        >
                            ...
                            <div style="width: 34%;float:left;min-width:300px">
                                <div style="float: left;padding-left: 24px;">
                                    <div class="jinribaomingshuClass">今日审核通过人数：</div>
                                ...
                                <el-progress
                                    type="circle"
                                    :percentage="conferenceInfo.todayPassCountPer"
                            ...
                            <div
                                :style="{'padding-right': '0.75em','padding-top': '1.5em','padding-bottom': '1.5em','padding-left': '1.5em','width': '22%','float':'left','max-width': leftRightMaxWidth + 'px'}"
                            >
                                <div
                    ...
                    <el-carousel-item v-if="conferenceoverview2">
                        ...
                        >
                            ...
                            <div style="width: 34%;float:left;min-width:300px">
                                ...
                                <el-progress
                                    type="circle"
                                    :percentage="vehicleInfo.todayUseVehiclePer"
                                    style="margin-right: -80px;float: right;height: 120px;margin-top:28px"
                                    :stroke-width="20"
                                    stroke-linecap="butt"
                                    color="#FF820A"
                    ...
                    <el-carousel-item v-if="conferenceoverview3">
                        ...
                        >
                            ...
                            <div style="width: 34%;float:left;min-width:300px">
                                ...
                                <el-progress
                                    type="circle"
                                    :percentage="roomInfo.todayUsePer"
                                    style="margin-right: -80px;float: right;height: 120px;margin-top:28px"
                                    :stroke-width="20"
                                    stroke-linecap="butt"
                                    color="#FF820A"
                    ...
                    <el-carousel-item v-if="conferenceoverview4">
                        ...
                        >
                            ...
                            <div style="width: 34%;float:left;min-width:300px">
                                ...
                                <el-progress
                                    type="circle"
                                    :percentage="dinnerInfo.todayPer"
                                    style="margin-right: -80px;float: right;height: 120px;margin-top:28px"
                                    :stroke-width="20"
                                    stroke-linecap="butt"
                                    color="#FF820A"
                    ...
                    <el-carousel-item v-if="conferenceoverview1">
                        ...
                        >
                            ...
                            <div style="width: 34%;float:left;min-width:300px">
                                ...
                                <el-progress
                                    type="circle"
                                    :percentage="conferenceInfo.conferenceTodayCheckInCountPer"
                                    style="margin-right: -80px;float: right;height: 120px;margin-top:28px"
                                    :stroke-width="20"
                                    stroke-linecap="butt"
                                    color="#FF820A"
