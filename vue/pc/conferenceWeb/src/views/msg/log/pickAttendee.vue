        ...
        <el-dialog ref="dialog" :visible.sync="dialogVisible" width="90%" top="10px" :show-close="false" append-to-body :before-close="closeDialog">
            <div style="margin-top:-40px">
                <div style="padding-left:8px;padding-right:8px;margin-top:8px">
                    <div class="clearfix">
                        <div style="background-color: white;padding-left:10px;padding-top: 15px">
                            <el-form :inline="true" :model="pageInfo">
                                ...
                                <el-form-item v-if="!dialogDisabled" label="标签">
                    ...
                    <div style="background-color: white;padding-left:10px;padding-top:10px;padding-right: 10px">
                        ...
                        >
                            <el-table-column v-show="!dialogDisabled" type="selection" width="55" />
                            ...
                            <el-table-column label="标签">
                                <template slot-scope="scope">
                                    ...
                                    <el-tag
                                        v-for="(tagVO) in scope.row.tagVOs"
                                        :key="tagVO.id"
            ...
            <span slot="footer" class="dialog-footer">
                <div style="margin-top:-30px">
                    <el-button v-show="!dialogDisabled" type="primary" @click="onSubmit">确 定</el-button>
...
export default {
    ...
    watch: {
        ...
        // receiveUserType(newType){
        //      this.pageInfo.attendeeRoleFlagEqual=(newType-1)+''
        //     // switch(newType) {
        //     //     case 1:
        //     //         this.pageInfo.attendeeRoleFlagEqual='0'
        //     //         break;
        //     //     case 2:
        //     //         this.pageInfo.attendeeRoleFlagEqual='1'
        //     //         break;
        //     //     case 3:
        //     //         this.pageInfo.attendeeRoleFlagEqual='2'
        //     //         break;
        //     //     case 4:
        //     //         this.pageInfo.attendeeRoleFlagEqual='3'
        //     //         break;
        //     //     case 5:
        //     //         this.pageInfo.attendeeRoleFlagEqual='4'
        //     //         break;
        //     // } 
    ...
    created() {
        console.log(this.receiveUserType,'this.receiveUserType0000')
    ...
    methods: {
        ...
        resetSearch() {
            ...
            this.pageInfo = {
                ...
                attendeeRoleFlagEqual: this.receiveUserType+''
            }
        },
        getList() {
            // this.pageInfo.tagIdsIn = []
            this.pageInfo.tagIdsNotIn = []
            if (this.modelType === 1) {
                this.pageInfo.tagIdsIn = [this.tagId]
            } else if (this.modelType === 2) {
                this.pageInfo.tagIdsNotIn = [this.tagId]
            }
            ...
            this.pageInfo.attendeeRoleFlagEqual=(this.receiveUserType-1)+''
