<template>
    ...
    <el-form ref="form" :inline="true" :model="form">
        ...
        <div class="form_left">
        <el-form-item label="到达时间" prop="arriveDoubleTime">
            <el-date-picker
        ...
        <el-form-item v-show="showMoreFlag" label="班次/车次" prop="arriveFlightLike">
            <el-input v-model.trim="form.arriveFlightLike" size="small" style="width: 100px" />
        </el-form-item>
...
export default {
    ...
    watch: {
        ...
        'showMoreFlag': {
            handler(newVal, oldVal) {
                if (newVal) {
                    // this.$emit('changeTableHeight', 251)
    ...
    methods: {
        getSearchData() {
            ...
            // })
            this.form.attendeeRoleFlagEqual = this.attendeeRoleFlagEqual.join(',')
