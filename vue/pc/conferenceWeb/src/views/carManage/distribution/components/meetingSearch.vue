<template>
    ...
    <el-form ref="form" :inline="true" :model="form">
        <el-form-item label="姓名" prop="attendeeNameLike">
            <el-input v-model.trim="form.attendeeNameLike" size="small" style="width: 110px" />
        </el-form-item>
        <el-form-item label="手机" prop="phoneLike">
            <el-input v-model.trim="form.phoneLike" size="small" style="width: 110px" />
        </el-form-item>

        <el-form-item label="到达地点" prop="arriveStationLike">
            <el-input v-model.trim="form.arriveStationLike" size="small" style="width: 110px" />
        </el-form-item>

        <el-form-item label="分配状态" prop="taskResult">
            <el-select v-model="form.taskResult" placeholder="默认全部" style="width:110px">
                <el-option v-for="item in taskResultOptions" :key="item.id" :label="item.value" :value="item.id" />
            </el-select>
        </el-form-item>

        <el-form-item label="标签" prop="tagIdsIn">
            <el-select v-model="form.tagIdsIn" placeholder="全部" clearable style="width:110px">
        ...
        <!-- <el-form-item v-show="showMoreFlag" label="到达时间" prop="arriveDoubleTime">
            <el-date-picker v-model="form.arriveDoubleTime" type="datetimerange" range-separator="-"
                start-placeholder="开始日期" end-placeholder="结束日期" format="yyyy-MM-dd HH:mm"
                :default-time="configDefaultTime" value-format="yyyy-MM-dd HH:mm:ss" />
        </el-form-item> -->

        <el-form-item v-show="showMoreFlag" label="单位名称" prop="allOrganizationNameLike">
            <el-input v-model.trim="form.allOrganizationNameLike" size="small" style="width: 110px" />
        </el-form-item>
        <el-form-item v-show="showMoreFlag" label="班次/车次" prop="arriveFlightLike">
            <el-input v-model.trim="form.arriveFlight" size="small" style="width: 110px" />
        </el-form-item>
        <el-form-item v-show="showMoreFlag && !changeRoutFlag" label="人员类别" prop="attendeeRoleFlagEqual">
        ...
        <el-form-item v-show="changeRoutFlag && showMoreFlag" label="人员类别" prop="attendeeRoleFlagEqual">
            <el-select v-model="attendeeRoleFlagEqual" placeholder="全部" collapse-tags multiple style="width:150px">
                <el-option v-for="item in attendeeRoleOptions" :key="item.id" :label="item.value" :value="item.id" />
            </el-select>
        </el-form-item>
        ...
        <el-form-item v-show="showMoreFlag" :label="getConferenceTemplate(1) + '议程'" prop="agendaIdsIn">
            <el-cascader v-model="agendaId" :options="yiChengOptions" :props="{ multiple: true, value: 'id',
                          label: 'name', children: 'children',checkStrictly: true,emitPath:false}" clearable
                collapse-tags style="width:210px" />
        </el-form-item>
        <el-form-item v-show="showMoreFlag" label="职级" prop="positionLevel">
            <el-select v-model="form.positionLevel" placeholder="全部" clearable style="width:100px">
                <el-option v-for="item in positionLevelOptions" :key="item.valCode" :label="item.valName"
                    :value="item.valCode" />
            </el-select>
        </el-form-item>
