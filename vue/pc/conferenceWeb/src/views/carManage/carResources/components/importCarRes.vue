        ...
        <el-dialog :title="title" :width="width" top="12%" v-if="dialogVisible" :visible.sync="dialogVisible"
            ...
            <div v-show="!shangchuanwancheng">
                <div style="width: 100%;padding-bottom:10px">
                    ...
                    <el-link :href="publicImagePath+'importTemplate/用车/车辆导入模板.xlsx'" :underline="false" type="primary"
                        style="float: right">
...
<script>
import { getImportCarResult } from '@/api/car'
...
export default {
    ...
    data () {
        return {
            ...
            uploadUrl: process.env.VUE_APP_BASE_API + '/synergy/files/import/vehicle',
            uploadData: {
                uuid: '',
    ...
    methods: {
        ...
        getImportCarResult () {
            getImportCarResult({ 'uuid': this.uploadData.uuid, 'conferenceId': getConferenceId() }).then(res => {
