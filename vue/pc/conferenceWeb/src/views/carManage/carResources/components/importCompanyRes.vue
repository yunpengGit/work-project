        ...
        <el-dialog :title="title" :width="width" top="12%" v-if="dialogVisible" :visible.sync="dialogVisible"
            ...
            <div v-show="!shangchuanwancheng">
                <div style="width: 100%;padding-bottom:10px">
                    ...
                    <el-link :href="publicImagePath+'importTemplate/用车/公司导入模板.xlsx'" :underline="false" type="primary"
                        style="float: right">
...
<script>
import { getImportCompanyResult } from '@/api/car'
...
export default {
    ...
    data () {
        return {
            ...
            uploadUrl: process.env.VUE_APP_BASE_API + '/synergy/files/import/vehicle/company',
            uploadData: {
                uuid: '',
    ...
    methods: {
        ...
        getImportCompanyResult () {
            getImportCompanyResult({ 'uuid': this.uploadData.uuid, 'conferenceId': getConferenceId() }).then(res => {
