    ...
    <div class="">
        ...
        >
            ...
            >
                ...
                <el-scrollbar wrap-class="scrollbar-wrapper" style="height:100%">
                    ...
                    <el-form-item label="乘车人手机号" prop="attendeePhone">
                        <el-input v-model="ruleForm.attendeePhone" class="width360" show-word-limit maxlength="11" disabled />
                    </el-form-item>
                    ...
                    <el-form-item v-if="ruleForm.contact === 0" label="联系人姓名" prop="contactPerson">
                        <el-input v-model="ruleForm.contactPerson" class="width360 keepOutRight" show-word-limit maxlength="30" placeholder="请输入联系人姓名" />
                    </el-form-item>
                    <el-form-item v-if="ruleForm.contact === 0" label="联系人电话" prop="contactPhone">
                        <el-input v-model="ruleForm.contactPhone" class="width360" show-word-limit maxlength="11" placeholder="请输入联系人电话" />
                    </el-form-item>
                </el-scrollbar>
            </el-form>
            <div class="demo-drawer__footer" style="height:60px;text-align:center;padding-right:20px;padding-top:3px;border-top:solid 1px #DDDDDD">
                ...
                <el-button type="primary" :disabled="ruleForm.attendees === null || ruleForm.attendees.length === 0" :loading="loading" style="height:32px;margin-top:12px" @click="insert">保存</el-button>
            </div>
        </el-drawer>
    </div>
</template>
