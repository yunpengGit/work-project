    ...
    >
        ...
        <div style="padding-left:8px;padding-right:8px;margin-top:0px">
            ...
            <div style="background-color: white;padding-left:10px;padding-top:10px;padding-right: 10px">
                ...
                >
                    <el-table-column label="姓名" align="left" width="130px">
                    ...
                    <el-table-column label="人员类型" align="left" width="110px">
                        <template slot-scope="scope">
                            <span v-show="scope.row.attendeeRoleFlag === 0">{{ getConferenceTemplate(2) }}</span>
                            <span v-show="scope.row.attendeeRoleFlag === 1">会务组</span>
                            <span v-show="scope.row.attendeeRoleFlag === 2">司机</span>
                            <span v-show="scope.row.attendeeRoleFlag === 3">嘉宾</span>
                            <span v-show="scope.row.attendeeRoleFlag === 4">临时来宾</span>
                        </template>
                    </el-table-column>
