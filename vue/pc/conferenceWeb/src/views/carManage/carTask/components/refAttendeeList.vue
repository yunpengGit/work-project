        ...
        <div class="clearfix">
            <div style="background-color: white;padding-left:10px;padding-top: 15px">
                <el-form :inline="true" :model="pageInfo">
                    ...
                    <el-form-item v-if="dakaichaxunClass === 0" label="人员类别" prop="attendeeRoleFlagEqual">
                        <el-select
                ...
                <el-dropdown @command="shaixuan">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item command="moren"
                            :class="!allColumnFlag ? 'isActiveClass' : 'isNotActiveClass'">默认列表</el-dropdown-item>
                        <el-dropdown-item command="quanbu"
                            :class="allColumnFlag ? 'isActiveClass' : 'isNotActiveClass'">全部列表</el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            ...
            >
                ...
                <el-table-column prop="name" label="姓名" :min-width="160">
                    <template slot-scope="scope">
                        <AttendeeInfomation :accompany-flag="2" :accompany-totips="scope.row.accompanyTotips" :photo-url="scope.row.ssoUserPhoto" :attendee-name="scope.row.fixAttributeCommonVO.attendeeName" :attendee-role-flag="scope.row.attendeeRoleFlag" :honour-flag="scope.row.fixAttributeCommonVO.honourFlag" :sex="scope.row.fixAttributeCommonVO.sex" />
                    </template>
                </el-table-column>
                <!-- width="180" -->
                <el-table-column
