        ...
        <el-dialog :title="title" :width="width" top="12%" v-if="dialogVisible" :visible.sync="dialogVisible"
            ...
            <div v-show="!shangchuanwancheng">
                <div style="width: 100%;padding-bottom:10px">
                    ...
                    <el-link :href="publicImagePath+'importTemplate/票证/证件导入模板.xlsx'" :underline="false" type="primary"
                        style="float: right">
...
<script>
import { getImportCardResult } from '@/api/card'
...
export default {
    ...
    data () {
        return {
            ...
            uploadUrl: process.env.VUE_APP_BASE_API + '/synergy/files/import/card',
            uploadData: {
                uuid: '',
    ...
    methods: {
        ...
        getImportCardResult () {
            getImportCardResult({ 'uuid': this.uploadData.uuid, 'conferenceId': getConferenceId() }).then(res => {
