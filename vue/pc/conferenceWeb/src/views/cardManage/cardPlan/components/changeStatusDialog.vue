...
export default {
    ...
    methods: {
        ...
        onSubmit () {
            ...
            var cardAttendeeList = [];
            this.selectedList.forEach(item => {
                var cardAttendee = { "attendee": { "id": item.attendee.id }, "card": { "id": item.card.id } };
                cardAttendeeList.push(cardAttendee);
            });
            var param = { "cardAttendeeList": cardAttendeeList, "cardStatus": this.cardStatus }
