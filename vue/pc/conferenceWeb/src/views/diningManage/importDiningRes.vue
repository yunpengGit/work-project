        ...
        <el-dialog :title="title" :width="width" top="12%" v-if="dialogVisible" :visible.sync="dialogVisible"
            ...
            <div v-show="!shangchuanwancheng">
                <div style="width: 100%;padding-bottom:10px">
                    ...
                    <el-link :href="publicImagePath+'importTemplate/用餐/餐厅导入模板.xlsx'" :underline="false" type="primary"
                        style="float: right">
...
<script>
import { getImportDiningResult } from '@/api/dining'
...
export default {
    ...
    data () {
        return {
            ...
            uploadUrl: process.env.VUE_APP_BASE_API + '/synergy/files/import/dining',
            uploadData: {
                uuid: '',
    ...
    methods: {
        ...
        getImportDiningResult () {
            getImportDiningResult({ 'uuid': this.uploadData.uuid, 'conferenceId': getConferenceId() }).then(res => {
