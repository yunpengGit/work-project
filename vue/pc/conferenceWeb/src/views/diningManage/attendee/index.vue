...
export default {
    ...
    mounted() {
        ...
        this.paramData.attendeeRoleFlagEqual = [0, 1, 2, 3, 4] // 20201228  列表查的不只是参会人 还有会务组和司机、嘉宾、临时参会人  所有任务下的参会人列表都要加入attendeeRoleFlagEqual  这个参数
