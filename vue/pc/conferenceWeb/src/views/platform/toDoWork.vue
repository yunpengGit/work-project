    ...
    <div class="caedback" style="height:100%">
        <div class="heightpos">
            <el-row style="padding-bottom:10px">
                <el-col :span="12">
                    <span class="cardtitle">待办工作</span>
                    &nbsp;
                    <span class="cardtitlered">({{ count }})</span>
                </el-col>
...
export default {
    ...
    methods: {
        gengduo() {
            this.$router.push({
                path: `/meetingCreate/todoWorkList/0`
            })
        },
        view(val) {
            ...
            // if (val.type === 50) {
            //     this.$router.push({ name: 'distribution', params: { sourceType: val.sourceType }})
            //     return
            // }
        ...
        getList() {
            getTaskList({
                statusFlag: 1, sortName: 'attendeetask.level desc, attendeetask.createTime',
                sortStatus: 'desc'
            }).then(res => {
