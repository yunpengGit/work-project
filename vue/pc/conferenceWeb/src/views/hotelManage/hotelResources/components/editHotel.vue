    ...
    <el-drawer :title="title" :before-close="handleClose" :visible.sync="dialog" direction="rtl"
        ...
        <el-form ref="form" size="small" :model="form" label-width="120px" :rules="rules"
            ...
            <el-scrollbar wrap-class="scrollbar-wrapper" style="height:100%">
                <el-form-item label="酒店名称" prop="name" style="width:80%">
                    <el-input class="keepOutRight" v-model="form.name" maxlength="50" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="酒店地址" prop="address" style="width:80%">
                    <el-input class="keepOutRight" v-model="form.address" maxlength="50" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="住宿须知" style="width:80%">
                    <el-input type="textarea" v-model="form.notice" maxlength="300" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="前台电话" style="width:80%">
                    <el-input v-model="form.businessPhone" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="联系人姓名" prop="contactPerson" style="width:80%">
                    <el-input class="keepOutRight" v-model="form.contactPerson" maxlength="30" show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="联系人手机号" prop="phone" style="width:80%">
                    <el-input class="keepOutRight" v-model="form.phone" maxlength="11" show-word-limit></el-input>
                </el-form-item>
...
<script>
import { updateHotel, addHotel, getHotelById } from '@/api/hotel'
