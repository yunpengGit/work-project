    ...
    <div class="form-drawer-body">
      <el-form ref="form" :model="form" label-position="left">
        <el-form-item
          ...
          prop="subject"
        >
          <p class="p-item-group" style="min-height:34px;height:auto">{{ form.subject }}</p>
        </el-form-item>
        ...
        <el-form-item
          ...
          prop="alarmTypes"
        >
          <p class="p-item-group" style="min-height:34px;height:auto">{{ getAlarmTypes }}</p>
        </el-form-item>
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <p class="p-item-group" style="min-height: 34px; height: auto">
            {{ getRecurrenceRule() }}
          </p>
        </el-form-item>
