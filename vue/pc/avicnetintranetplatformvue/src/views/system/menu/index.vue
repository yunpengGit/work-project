    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType == 'C'" label="三员菜单">
              <el-radio-group v-model="form.isSyMenu" :disabled="optType === 'edit'">
  ...
  methods: {
    ...
    handleUpdate (row) {
      ...
      getMenu(row.menuId).then(response => {
        const { isSyMenu } = response.data
        this.form = response.data
        this.form.isSyMenu = isSyMenu === null ? '0' : isSyMenu
        this.open = true
        this.title = '修改菜单'
      })
    },
