 ...
 * @LastEditors: zongmz
 * @LastEditTime: 2021-04-21 17:29:32
 */
...
export default function (Vue, UI) {
  ...
  return {
    ...
    data () {
      ...
      // console.log(params, parsedParams, 292929)
      return {
        params,
        timer: null,
        proxy: {
    ...
    methods: {
      ...
      emitChange (prop, value) {
        ...
        // console.log(parentListeners, events, 22333)
        ...
        this.timer = setTimeout(() => {
          ...
          // console.log(formParams, this.proxy, 8787)
          this.$emit(
            'change',
            formParams
              ? {
