  ...
  methods: {
    ...
    canvasClick(e) {
      ...
      if (this.num == this.checkNum) {
        ...
        setTimeout(() => {
          ...
          // var captchaVerification = aesEncrypt(this.backToken)
          var captchaVerification = this.backToken
          const data = {
          ...
          reqCheck(data).then(res => {
            if (res.code == '1000000') {
              ...
              this.$parent.$emit('successFn', { captchaVerification })
            } else {
    ...
    getPictrue() {
      ...
      reqGet(data).then(res => {
        if (res.code == '1000000') {
          this.pointBackImgBase = res.model.originalImageBase64
          this.backToken = res.model.token
          this.poinTextList = res.model.wordList
