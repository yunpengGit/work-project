        ...
        <div class="table-page-search-wrapper">
          ...
          >
            <a-row :gutter="48">
              ...
              <a-col :md="8" :sm="24">
                <a-form-item label="起始地三字代码">
                  <a-input
                    v-model="queryParam.startPrn"
                    placeholder="请输入"
                  />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
                <a-form-item label="目的地三字代码">
                  <a-input
                    v-model="queryParam.endPrn"
                    placeholder="请输入"
                  />
                </a-form-item>
              </a-col>
...
<script>
import { save, update, getPageByParams, deleteById, deleteByIds } from '@/api/dataDictionary/mileage.js'
...
export default {
  ...
  methods: {
    ...
    editFn(record) {
      ...
      // 表单回显传参不允许传入表单没有的字段，必须传入
      const drawerFormData = {
        id: record.id, startPrn: record.startPrn, endPrn: record.endPrn, mileage: record.mileage
      }
