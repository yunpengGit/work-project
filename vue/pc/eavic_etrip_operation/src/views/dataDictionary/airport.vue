  ...
  <div>
    ...
    >
      ...
      >
        ...
        <a-form-item label="机场三字码">
          <a-input
            v-decorator="['prn', { rules: [{ required: true, message: '必填项' }] }]"
            placeholder="请输入"
          />
        </a-form-item>
        <a-form-item label="国家中文名称">
        ...
        <a-form-item label="国家简称">
          <a-input
            v-decorator="['countryAbbreviation']"
            placeholder="请输入"
          />
        </a-form-item>
        <a-form-item label="机场名称">
          <a-input
            v-decorator="['airportName']"
            placeholder="请输入"
          />
        </a-form-item>
        <a-form-item label="机场名称英文">
          <a-input
            v-decorator="['airportEnName']"
            placeholder="请输入"
          />
        </a-form-item>
        <a-form-item label="省分名称">
        ...
        <a-form-item label="城市拼音">
          <a-input
            v-decorator="['citySpell']"
            placeholder="请输入"
          />
        </a-form-item>
        <a-form-item label="城市拼音缩写">
          <a-input
            v-decorator="['cityShortening']"
            placeholder="请输入"
          />
        </a-form-item>
        <!-- <a-form-item label="状态" >
...
<script>
import { save, update, getPageByParams, deleteById, deleteByIds } from '@/api/dataDictionary/airport.js'
  ...
  methods: {
    ...
    editFn(record) {
      ...
      const drawerFormData = {
        ...
        airportEnName: record.airportEnName,
        province: record.province,
        city: record.city,
        cityShortening: record.cityShortening,
        citySpell: record.citySpell
      }
