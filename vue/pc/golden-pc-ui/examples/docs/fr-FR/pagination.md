...
| page-num | Le numéro de page courant, supporte le modificateur .sync. | number | — | 1 |
...
| current-change | Se déclenche quand `page-num` change. | La nouvelle page courante |
