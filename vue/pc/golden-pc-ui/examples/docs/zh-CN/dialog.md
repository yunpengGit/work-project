...
:::demo size 属性值 mini small medium。

```html
<el-button type="text" @click="openDialog('mini')">点击打开 DialogMini</el-button>
<el-button type="text" @click="openDialog('small')">点击打开 DialogSmall</el-button>
<el-button type="text" @click="openDialog('medium')">点击打开 DialogMedium。</el-button>
