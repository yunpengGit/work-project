...
```html
<div class="block">
  <span class="demonstration">mini大于 7 页时的效果</span>
  <el-pagination
    size="mini"
    layout="prev, pager, next"
    :total="1000">
...
<div class="block">
  <span class="demonstration">small大于 7 页时的效果</span>
  <el-pagination
    background
    size="small"
    layout="prev, pager, next"
...
<div class="block">
  <span class="demonstration">medium大于 7 页时的效果</span>
  <el-pagination
    background
    size="medium"
    layout="prev, pager, next"
...
| page-num | 当前页数，支持 .sync 修饰符 | number | — | 1 |
...
| current-change | pageNum 改变时会触发 | 当前页 |
