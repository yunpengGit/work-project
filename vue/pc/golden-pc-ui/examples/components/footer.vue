  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="http://39.106.194.166/zhjw-fe/golden-pc-ui" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
      ...
      <div class="footer-main">
        ...
        <a href="http://39.106.194.166/zhjw-fe/golden-pc-ui/issues" class="footer-main-link" target="_blank">{{ langConfig.feedback }}</a>
        <a :href="`http://39.106.194.166/zhjw-fe/golden-pc-ui/blob/master/CONTRIBUTING.${ lang }.md`" class="footer-main-link" target="_blank">{{ langConfig.contribution }}</a>
        <!-- <a href="https://segmentfault.com/t/golden-pc-ui" class="footer-main-link" target="_blank">SegmentFault</a> -->
        <!-- <a href="https://github.com/ElementUI/awesome-element" class="footer-main-link" target="_blank">Awesome Element</a> -->
      </div>
      <div class="footer-social">
        <p class="footer-social-title">GoldenPcUi {{ version && version.slice(0, 3) }} Fullerene</p>
        <!-- <el-popover
          ref="weixin"
          placement="top"
          width="120"
        ...
        <a href="http://39.106.194.166/zhjw-fe/golden-pc-ui" target="_blank">
