...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      let fragments = `<li><h3><a href="http://39.106.194.166/zhjw-fe/golden-pc-ui/tree/v${release}" target="_blank">${release}</a></h3>`;
      ...
      for (let len = changeLogNodes.length, i = 2; i < len; i++) {
        ...
        if (node.tagName !== 'H3') {
          ...
          fragments += `</li><li><h3><a href="http://39.106.194.166/zhjw-fe/golden-pc-ui/tree/v${release}" target="_blank">${release}</a></h3>`;
        }
      }
      fragments = fragments.replace(/#(\d+)/g, '<a href="http://39.106.194.166/zhjw-fe/golden-pc-ui/issues/$1" target="_blank">#$1</a>');
