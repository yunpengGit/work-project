<script type="text/jsx">
  ...
  import Menubar from 'golden-pc-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'golden-pc-ui/src/utils/dom';
      ...
      const component = (
        <ul
          ...
          class={{
            ...
            "el-menu": true,
            ['el-menu--' + this.menuSize]: this.menuSize? 'el-menu--' + this.menuSize : ''
          }}
        >
          { this.$slots.default }
        </ul>
