...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'golden-pc-ui/src/utils/date-util';
  import { hasClass } from 'golden-pc-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'golden-pc-ui/src/utils/util';
