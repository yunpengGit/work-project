...
<script>
import Popper from 'golden-pc-ui/src/utils/vue-popper';
import Clickoutside from 'golden-pc-ui/src/utils/clickoutside';
import Emitter from 'golden-pc-ui/src/mixins/emitter';
import Locale from 'golden-pc-ui/src/mixins/locale';
import Migrating from 'golden-pc-ui/src/mixins/migrating';
import ElInput from 'golden-pc-ui/packages/input';
import ElTag from 'golden-pc-ui/packages/tag';
import ElScrollbar from 'golden-pc-ui/packages/scrollbar';
import ElCascaderPanel from 'golden-pc-ui/packages/cascader-panel';
import AriaUtils from 'golden-pc-ui/src/utils/aria-utils';
import { t } from 'golden-pc-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'golden-pc-ui/src/utils/util';
import { isUndefined, isFunction } from 'golden-pc-ui/src/utils/types';
import { isDef } from 'golden-pc-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'golden-pc-ui/src/utils/resize-event';
