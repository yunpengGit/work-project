 ...
 * @LastEditTime: 2021-09-10 01:23:33
 * @LastEditors: zhaohx
...
<template>
  <div class="add-attendee-container">
    ...
    <!-- 报名待审核 -->
    <div class="single-btn-bottom" v-if="isLoading && param.signStatus === 1" :class="routeParams.isBacklog ? '' : 'single-btn-bottom-allow'">
      <van-button
            ...
            eleDetail.forEach(eleArr => {
              ...
              if (eleArr.type === 9) {
                if (eleArr.fieldValue) {
                  console.log(9, eleArr.field, eleArr.fieldValue)
