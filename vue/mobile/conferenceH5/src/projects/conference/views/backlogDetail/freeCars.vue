 ...
 * @LastEditors: zhaohx
 * @LastEditTime: 2021-09-03 15:24:11
-->
<template>
...
export default {
  ...
  data() {
    return {
      ...
      tabsTypeData: [
        { text: '任务车辆', checked: false, queryType: '1' },
        { text: '空闲车辆', checked: true, queryType: '2' }
      ],
      filterDate: '全部用车时间',
      sidePopupShow: false,
      filterInput: {
      ...
      params: {
        ...
        httpParams: {
          conferenceId: '',
          startTime: '2021-08-21 10:16:00',
          endTime: '2021-08-21 12:16:00',
          pageNum: 1,
          pageSize: 10,
          // 座位
          seatNumList: [],
