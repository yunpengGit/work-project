 ...
 * @LastEditors: zhaohx
 * @LastEditTime: 2021-08-31 09:16:09
-->
<template>
  <div class="message-detail-container">
      ...
      <template v-slot:item="data">
        <div v-for="(ele, index) in data.data" :key="index" class="msg-item">
          ...
          <div class="car-people-info">
            ...
            <div class="company">{{ ele.organizationName || ele.organizationSortName }}</div>
    ...
    <div class="single-btn-bottom single-btn-bottom-allow" v-if="routeParams.status === '0'">
