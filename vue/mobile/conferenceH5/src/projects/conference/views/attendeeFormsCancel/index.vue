 ...
 * @LastEditTime: 2021-09-10 01:23:39
 * @LastEditors: zhaohx
  ...
  <div class="add-attendee-container">
    ...
    <van-overlay :show="examineShow" z-index="999" class-name="examine-container">
      <div class="examine">
        ...
        <ul class="oper">
          <li @click="examineCancelHandler">退回</li>
          <li @click="examineClose">关闭</li>
        </ul>
      </div>
    </van-overlay>
    <div class="single-btn-bottom single-btn-bottom-allow" v-if="isLoading && routeParams.isBacklog">
      <van-button
        type="info"
        @click="examineCancel"
      >审批</van-button>
...
export default {
  ...
  methods: {
    examineCancelHandler() {
      ...
      const verifyReason = this.examineReason
      const subParams = {
