 ...
 * @LastEditors: zhaohx
 * @LastEditTime: 2021-09-02 10:04:49
-->
<template>
        ...
        <template v-slot:item="data">
          ...
          >
            <dl>
              ...
              <dd
                v-if="ele.fixAttributeCommonVO.organizationSortName || ele.fixAttributeCommonVO.organizationName || ele.fixAttributeCommonVO.deptName"
              >
                {{ ele.fixAttributeCommonVO.organizationSortName ? ele.fixAttributeCommonVO.organizationSortName : ele.fixAttributeCommonVO.organizationName }} <span v-if="(ele.fixAttributeCommonVO.organizationSortName || ele.fixAttributeCommonVO.organizationName) && ele.fixAttributeCommonVO.deptName">/</span> {{ ele.fixAttributeCommonVO.deptName }}
              </dd>
