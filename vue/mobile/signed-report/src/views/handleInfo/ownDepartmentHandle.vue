<template>
    <div>
      ...
      <RadioBox :list="list"  listType="ownDepartmentHandle" :sourceData="sourceData"/>
    </div>
</template>
...
import RadioBox from '@c/RadioBox'
...
export default {
  ...
  methods: {
    ...
    init (parent) {
      let apiText = 'ownDepartmentHandleInit'
      let processId
      let filter
      this.roleType = this.$store.state.handle.roleType
      if (this.roleType === 'groupCreate') {
        apiText = 'ownIMISLeaderCirculateInit'
        processId = this.$store.state.handle.processId
      } else if (this.roleType === 'groupHost') {
        apiText = 'ownLeaderInit'
      } else if (this.roleType === 'groupAllTube' || this.roleType === 'deptLader' || this.roleType === 'groupDepartmentLeader') {
        filter = 'xzzl'
      }
      handleApi[apiText](
        {
